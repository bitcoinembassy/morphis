...
ESCAPE = bytes((0x1b, 0x5b))
UP_ARROW = bytes((0x1b, 0x5b, 0x41))
DOWN_ARROW = bytes((0x1b, 0x5b, 0x42))
RIGHT_ARROW = bytes((0x1b, 0x5b, 0x43))
LEFT_ARROW = bytes((0x1b, 0x5b, 0x44))
END = bytes((0x1b, 0x5b, 0x46))
HOME = bytes((0x1b, 0x5b, 0x48))
INSERT = bytes((0x1b, 0x5b, 0x32, 0x7e))
DELETE = bytes((0x1b, 0x5b, 0x33, 0x7e))
PAGE_UP = bytes((0x1b, 0x5b, 0x35, 0x7e))
PAGE_DOWN = bytes((0x1b, 0x5b, 0x36, 0x7e))
